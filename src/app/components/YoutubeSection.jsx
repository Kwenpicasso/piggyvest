  ...
  return (
    <section className="w-full h-full max-w-[1550px] mx-auto ">
       ...
       <div className="flex justify-center items-center flex-col gap-5">
          ...
          <p className="text-xl w-full text-center font-light sm:text-base sm:w-full lg:text-center text-black">Every month, we shine a spotlight on one saver, asking them about their savings culture and how piggyvest has helped them.</p>
        </div>
